(() => {
    ...
    (() => {
        ...
        const initSlider = () => new core(".targeting__slider", {
        ...
        function initMainMenu() {
            ...
            menuContainerElem.addEventListener("click", (event => {
                if (event.target.classList.contains("menu-text-btn") || !event.target.closest(".main-menu__wrap")) {
        ...
        function initNavToSection() {
            ...
            let clickHandler = event => {
                ...
                if (!scrollTo(sectionId)) location.assign(`${location.origin}/?section=${sectionId}`);
            };
